...
export class UniswapV3Factory__parametersResult {
  value0: Address;
  value1: Address;
  value2: Address;
  value3: i32;
...
export class UniswapV3Factory extends ethereum.SmartContract {
  ...
  parameters(): UniswapV3Factory__parametersResult {
    let result = super.call(
      "parameters",
  ...
  try_parameters(): ethereum.CallResult<UniswapV3Factory__parametersResult> {
    let result = super.tryCall(
      "parameters",
      "parameters():(address,address,address,uint24,int24)",
      []
    ...
    return ethereum.CallResult.fromValue(
      new UniswapV3Factory__parametersResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toAddress(),
        value[3].toI32(),
