...
export class CurveGaugeAllocator__showPrinciplePnLResult {
  value0: boolean;
  value1: BigInt;
...
export class CurveGaugeAllocator__tokenInfoResult {
  value0: Address;
  value1: Address;
  value2: BigInt;
  value3: BigInt;
...
export class CurveGaugeAllocator extends ethereum.SmartContract {
  static bind(address: Address): CurveGaugeAllocator {
    return new CurveGaugeAllocator("CurveGaugeAllocator", address);
  }

  curve2Pool(): Address {
    let result = super.call("curve2Pool", "curve2Pool():(address)", []);

    return result[0].toAddress();
  }

  try_curve2Pool(): ethereum.CallResult<Address> {
    let result = super.tryCall("curve2Pool", "curve2Pool():(address)", []);
    if (result.reverted) {
  ...
  curveGauge(): Address {
    let result = super.call("curveGauge", "curveGauge():(address)", []);

    return result[0].toAddress();
  }

  try_curveGauge(): ethereum.CallResult<Address> {
    let result = super.tryCall("curveGauge", "curveGauge():(address)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  enableSendback(): boolean {
    let result = super.call("enableSendback", "enableSendback():(bool)", []);

    return result[0].toBoolean();
  }

  try_enableSendback(): ethereum.CallResult<boolean> {
    let result = super.tryCall("enableSendback", "enableSendback():(bool)", []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  showPrinciplePnL(
    token: Address
  ): CurveGaugeAllocator__showPrinciplePnLResult {
    let result = super.call(
      "showPrinciplePnL",
      "showPrinciplePnL(address):(bool,uint256)",
      [ethereum.Value.fromAddress(token)]
    );

    return new CurveGaugeAllocator__showPrinciplePnLResult(
      result[0].toBoolean(),
      result[1].toBigInt()
    );
  }

  try_showPrinciplePnL(
    token: Address
  ): ethereum.CallResult<CurveGaugeAllocator__showPrinciplePnLResult> {
    let result = super.tryCall(
      "showPrinciplePnL",
      "showPrinciplePnL(address):(bool,uint256)",
      [ethereum.Value.fromAddress(token)]
    ...
    return ethereum.CallResult.fromValue(
      new CurveGaugeAllocator__showPrinciplePnLResult(
        value[0].toBoolean(),
        value[1].toBigInt()
      )
    );
  ...
  tokenInfo(param0: Address): CurveGaugeAllocator__tokenInfoResult {
    let result = super.call(
      "tokenInfo",
      "tokenInfo(address):(address,address,int128,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    );

    return new CurveGaugeAllocator__tokenInfoResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_tokenInfo(
    param0: Address
  ): ethereum.CallResult<CurveGaugeAllocator__tokenInfoResult> {
    let result = super.tryCall(
      "tokenInfo",
      "tokenInfo(address):(address,address,int128,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromAddress(param0)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new CurveGaugeAllocator__tokenInfoResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  totalRewards(param0: Address): BigInt {
    let result = super.call("totalRewards", "totalRewards(address):(uint256)", [
      ethereum.Value.fromAddress(param0)
    ]);
  ...
  try_totalRewards(param0: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "totalRewards",
      "totalRewards(address):(uint256)",
      [ethereum.Value.fromAddress(param0)]
    );
    if (result.reverted) {
      return new ethereum.CallResult();
...
export class ConstructorCall__Inputs {
  ...
  get _curveGauge(): Address {
    return this._call.inputValues[1].value.toAddress();
  }

  get _curve2Pool(): Address {
...
export class DisableSendbackCall extends ethereum.Call {
  get inputs(): DisableSendbackCall__Inputs {
    return new DisableSendbackCall__Inputs(this);
  }

  get outputs(): DisableSendbackCall__Outputs {
    return new DisableSendbackCall__Outputs(this);
  }
}

export class DisableSendbackCall__Inputs {
  _call: DisableSendbackCall;

  constructor(call: DisableSendbackCall) {
    this._call = call;
  }
}

export class DisableSendbackCall__Outputs {
  _call: DisableSendbackCall;
...
export class SendBackCall extends ethereum.Call {
  get inputs(): SendBackCall__Inputs {
    return new SendBackCall__Inputs(this);
  }

  get outputs(): SendBackCall__Outputs {
    return new SendBackCall__Outputs(this);
  }
}

export class SendBackCall__Inputs {
  _call: SendBackCall;

  constructor(call: SendBackCall) {
    this._call = call;
  }
...
export class SendBackCall__Outputs {
  _call: SendBackCall;
